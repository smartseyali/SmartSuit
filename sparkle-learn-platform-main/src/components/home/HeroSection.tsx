        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center min-h-[calc(100vh-200px)]">
          ...
          <div className="text-primary-foreground space-y-8">
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-display font-bold leading-tight animate-fade-up delay-100">
              ...
              <span className="block text-accent mt-2">Healthcare Excellence</span>
            </h1>

            <p className="text-lg md:text-xl text-primary-foreground/80 max-w-xl animate-fade-up delay-200">
              Join India's leading medical education platform. Learn from experienced clinicians, master diagnostic techniques, and get placed at top hospitals.
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-4 animate-fade-up delay-300">
              ...
              <Button variant="heroOutline" size="xl" asChild>
                <Link to="/gallery" className="gap-3">
          ...
          <div className="relative hidden lg:block">
            <div className="relative w-full aspect-square">
              ...
              <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-80 bg-card rounded-2xl shadow-elevated overflow-hidden animate-float">
                <img
                  src="https://images.unsplash.com/photo-1579152276532-535c21af3bb5?w=600&auto=format&fit=crop"
                  alt="Medical laboratory"
                  className="w-full h-48 object-cover"
                />
                <div className="p-6">
                  <div className="text-sm text-muted-foreground mb-2">Featured Course</div>
